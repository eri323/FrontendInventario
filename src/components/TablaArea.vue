    ...
    <div class="container">
        ...
        />
            ...
            <div class="btn-agregar">
                <q-btn color="secondary" label="Agregar ➕" @click="agregarArea()" />
            </div>
            <div class="q-pa-md">
                <q-table flat bordered title="Treats" :rows="rows" :columns="columns" row-key="index" virtual-scroll
                    ...
                    <template v-slot:body-cell-opciones="props">
                        <q-td :props="props" class="botones">
                            <q-btn color="white" text-color="black" label="🖋️" @click="editarArea(props.row._id)" />
                            <q-btn color="white" text-color="black" label="❌" @click="inactivarArea(props.row._id)"
                                v-if="props.row.estado == 1" />
                            <q-btn color="white" text-color="black" label="✅" @click="activarArea(props.row._id)"
                                v-else />
                        </q-td>
                    </template>
                </q-table>
